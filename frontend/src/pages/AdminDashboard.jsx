...
import { 
  ...
  Home, MessageSquare, Menu, X, ChevronRight, ChevronLeft, PanelLeft
} from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  // --- STATE UTAMA ---
  // Default: Terbuka di desktop (>768px), Tertutup di mobile
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      setIsMobile(mobile);
      // Logic: Jika resize ke desktop, kembalikan sidebar ke terbuka (opsional)
  ...
  return (
    <div className="flex h-screen bg-surface font-sans text-primary overflow-hidden">
      ...
      <main className="flex-1 flex flex-col h-screen min-w-0 bg-surface relative">
        ...
        {/* CATATAN: Tombol Menu SUDAH DIHAPUS dari sini sesuai permintaan */}
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-6 custom-scrollbar">
          ...
          {/* --- TOMBOL SLIDE/TOGGLE (POSISI BARU: DI BAWAH HEADER) --- */}
          <div className="flex items-center">
            ...
            >
                {/* Ikon berubah tergantung status sidebar */}
